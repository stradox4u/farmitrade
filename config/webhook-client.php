...
return [
    'configs' => [
        [
             ...
             */
            'signing_secret' => config('paystack.secret_key'),
             ...
             */
            'signature_validator' => App\SignatureValidation\PaystackSignatureValidator::class,
        ...
        [
             ...
             * is used to verify that the payload has not been tampered with.
             */
            'signing_secret' => config('nexmo.signature_secret'),
             ...
             * This should be set to a class that extends \Spatie\WebhookClient\ProcessWebhookJob.
             */
            'process_webhook_job' => App\Jobs\ProcessNexmoWebhookJob::class,
        ],
    ],
];
