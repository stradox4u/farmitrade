...
<br>
<p>With respect to your listing on &nbsp;<a href="https://farmitrade.com.ng">Farmitrade</a>, of {{ $relevantListing->quantity }}&nbsp;{{ $relevantListing->unit }}&nbsp;of&nbsp;{{ ucwords($relevantListing->produce) }}, we are glad to inform you that a user has indicated interest in doing business with you.</p>
<br>
