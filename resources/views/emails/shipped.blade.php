...
<br>
<p>Your transaction to purchase {{ $transaction->quantity }}&nbsp;{{ $transaction->unit }} of {{ $transaction->produce }} with id:{{ $transaction->transaction_id_for_paystack }} has just been shipped.</p>
<br>
