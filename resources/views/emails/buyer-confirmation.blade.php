...
<br>
<p>We have recieved your payment of &#8358;&nbsp;{{ number_format($payment->total_amount / 100, 2) }} for your transaction with id:&nbsp;{{ $payment->transaction->transaction_id_for_paystack }}, to purchase {{ $payment->transaction->quantity }}&nbsp;{{ $payment->transaction->unit }} of {{ ucwords($payment->transaction->produce) }}.</p>
<br>
