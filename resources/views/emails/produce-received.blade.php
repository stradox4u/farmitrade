...
<br>
<p>Your transaction with id:&nbsp;{{ $transaction->transaction_id_for_paystack }}, to supply {{ $transaction->quantity }}&nbsp;{{ $transaction->unit }} of {{ ucwords($transaction->produce) }} has been received by the buyer.</p>
<br>
