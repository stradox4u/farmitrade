...
<br>
<p>Your transaction with id:&nbsp;{{ $payment->transaction->transaction_id_for_paystack }}, to supply {{ $payment->transaction->quantity }}&nbsp;{{ $payment->transaction->unit }} of {{ $payment->transaction->produce }} has been paid for by the buyer.</p>
<br>
