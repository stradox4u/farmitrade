                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('profile.update', $profile->id) }}" enctype="multipart/form-data" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col w-100">
                                <input id="bank_name" type="text" class="form-control @error('bank_name') is-invalid @enderror" name="bank_name" value="{{ $profile->bank_name }}" autocomplete="bank_name" autofocus placeholder="Bank Name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col w-100">
                                <input id="account_number" type="text" class="form-control @error('account_number') is-invalid @enderror" name="account_number" value="{{ $profile->account_number }}" autocomplete="account_number" autofocus placeholder="Account Number">
